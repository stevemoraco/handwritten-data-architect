      ...
      <DialogContent className="sm:max-w-md">
        ...
        <Tabs defaultValue="register" value={activeTab} onValueChange={(value) => setActiveTab(value as "login" | "register")}>
          ...
          <TabsContent value="login">
            <AuthForm onComplete={handleComplete} redirectPath={redirectPath} initialView="sign_in" />
          </TabsContent>
          <TabsContent value="register">
            <AuthForm onComplete={handleComplete} redirectPath={redirectPath} initialView="sign_up" />
          </TabsContent>
        </Tabs>
      </DialogContent>
    </Dialog>
